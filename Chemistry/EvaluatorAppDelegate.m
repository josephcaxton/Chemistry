...
static NSString* const kAnalyticsAccountId = @"UA-31971143-1";
...
@synthesize AllocatedMarks,Difficulty,Topic,TypeOfQuestion,NumberOfQuestions,DomainName,NumberOfQuestionsDisplayed,PossibleScores,ClientScores,buyScreen,SecondThread,m_facebook,FinishTestNow;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    if (![[GANTracker sharedTracker] trackEvent:@"Chemistry iPad Started"
                                         action:@"Launch iOS"
                                          label:@"Launch iOS"
                                          value:1
                                      withError:&error]) {
