...
-(IBAction)ShareThisAppViaMail:(id)sender{
	...
	if ([MFMailComposeViewController canSendMail]) {
        ...
        [SendMailcontroller setMessageBody:[NSString stringWithFormat:@"Checkout the free LearnersCloud Chemistry Q & A app. Its loaded with quality revision questions and answers. For iPad version<a href=http://itunes.apple.com/us/app/gcse-chemistry-questions./id421349385?ls=1&mt=8> click here</a>. For iPhone version<a href=http://itunes.apple.com/us/app/gcse-chemistry-questions/id423199816?ls=1&mt=8>  click here</a>. Or search for LearnersCloud in the itunes app store to view a list of all LearnersCloud apps. Android apps available at Google play and Amazon.com. LearnersCloud is a top 20 winner of the BETT show award 2012. "] isHTML:YES];
...
-(void)ConnectToFaceBook {
    ...
    facebook = [[Facebook alloc] initWithAppId:@"454970801194066" andDelegate:self];
    ...
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   @"Hey!!!. I'm practicing GCSE Chemistry Questions on this great new app, it really helped me and i hope it helps you too. You should try it out. Download it now for your iPad, iPhone and iPod Touch",  @"message",nil];
