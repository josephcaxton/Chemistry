...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (tableView.tag == 1) {
        ...
        if (TVHeaderImageView == nil) {
            ...
            NSString *HeaderImagePath = [[NSBundle mainBundle] pathForResource:@"EQ_chemistry_header" ofType:@"png"];
...
- (void)reviewPressed {
    ...
    // Report to  analytics
    NSError *error;
    if (![[GANTracker sharedTracker] trackEvent:@"User Sent to Review Chemistry Question iPad at app store"
                                         action:@"User Sent to Review Chemistry Question iPad at app store"
                                          label:@"User Sent to Review Chemistry Question iPad at app store"
                                          value:1
                                      withError:&error]) {
    ...
    NSString *str = @"https://userpub.itunes.apple.com/WebObjects/MZUserPublishing.woa/wa/addUserReview?id=421349385&type=Purple+Software"; 
